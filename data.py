...
IMAGENET_PATH = '/media/ryan/ILSVRC2012/'
DATA_DIR = '/home/ryan/Datasets/'
URLs = {
...
def get_data_provider(name, training=True):
    if name == 'imagenet':
        ...
        url = URLs['mnist']
        __maybe_download(url, path)
        mnist = mnist_input.read_data_sets(path, one_hot=True)
        return mnist.train.next_batch, mnist.test.next_batch
